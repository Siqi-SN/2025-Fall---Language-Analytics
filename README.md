...
## MOOC_POS_tags
This file uses the Bing sentiment lexicon to calculate the number of positive and negative POS-tags, specifically adjectives, adverbs, and verbs. The counts are then normalized by the total word count.
